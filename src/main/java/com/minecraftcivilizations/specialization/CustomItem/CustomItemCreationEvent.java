...
public class CustomItemCreationEvent extends Event implements Cancellable {
    ...
    private final CustomItemBase custom_item_class;
    private final ItemStack item_stack;
    private final Player player;
    private boolean cancelled;

    public CustomItemCreationEvent(CustomItemBase custom_item_class, ItemStack item_stack, Player creator) {
        this.custom_item_class = custom_item_class;
        this.item_stack = item_stack;
        this.player = creator;
    }

    public CustomItemBase getCustomItemClass() {
